...
class BSTLSum{
    ...
    public void menu(){
        ...
        System.out.println("4.Leaf Nodes Sum");
        System.out.println("5.Non leaf Nodes Sum");
        while(true){
    ...
    public int nonLeafNodes(Node root){
        if(root==null){
            ...
            return root.data+nonLeafNodes(root.left)+nonLeafNodes(root.right);
        }
        else{
